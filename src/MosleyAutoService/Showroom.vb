    ...
    Private Sub Showroom_Tick(sender As Object, e As EventArgs) Handles Me.Tick
        Try
            ...
            If GetInteriorID(ply.Position) = mosleyIntID Then
                SpawnPed(PedHash.Hipster01AFY, pdmPed, srDoor, 139.4474, True)
                SpawnVehicle(parkBike1, bike1, bPos1, bRot1, True)
                SpawnVehicle(parkBike2, bike2, bPos2, bRot2, True)
                SpawnVehicle(parkBike3, bike3, bPos3, bRot3, True)
                SpawnVehicle(parkBike4, bike4, bPos4, bRot4, True)
                SpawnVehicle(parkCar1, car1, cPos1, cRot1, True)
                SpawnVehicle(parkCar2, car2, cPos2, cRot2, True)
                SpawnVehicle(parkCar3, car3, cPos3, cRot3, True)
                SpawnVehicle(parkCar4, car4, cPos4, cRot4, True)
                SpawnVehicle(parkCar5, car5, cPos5, cRot5, True)
                SpawnVehicle(parkCar6, car6, cPos6, cRot6, True)
                SpawnVehicle(parkCar7, car7, cPos7, cRot7, True)
                SpawnVehicle(parkCar8, car8, cPos8, cRot8, True)
                SpawnVehicle(parkCar9, car9, cPos9, cRot9, True)
                SpawnVehicle(parkCar10, car10, cPos10, cRot10, True)
                SpawnVehicle(parkCar11, car11, cPos11, cRot11, True)

                If (GTA.Native.Function.Call(Of Boolean)(GTA.Native.Hash.IS_INTERIOR_SCENE)) Then
                    pdmPed.FreezePosition = False
                End If
            ...
            If Not ply.IsInVehicle AndAlso Not ply.IsDead AndAlso srDoorDist < 3.0 AndAlso Game.Player.WantedLevel = 0 AndAlso TaskScriptStatus = -1 Then
                If Not pdmPed = Nothing Then pdmPed.FreezePosition = False
                If Not bike1 = Nothing Then bike1.PlaceOnGround()
                If Not bike2 = Nothing Then bike2.PlaceOnGround()
                If Not bike3 = Nothing Then bike3.PlaceOnGround()
                If Not bike4 = Nothing Then bike4.PlaceOnGround()
                If Not car1 = Nothing Then car1.PlaceOnGround()
                If Not car2 = Nothing Then car2.PlaceOnGround()
                If Not car3 = Nothing Then car3.PlaceOnGround()
                If Not car4 = Nothing Then car4.PlaceOnGround()
                If Not car5 = Nothing Then car5.PlaceOnGround()
                If Not car6 = Nothing Then car6.PlaceOnGround()
                If Not car7 = Nothing Then car7.PlaceOnGround()
                If Not car8 = Nothing Then car8.PlaceOnGround()
                If Not car9 = Nothing Then car9.PlaceOnGround()
                If Not car10 = Nothing Then car10.PlaceOnGround()
                If Not car11 = Nothing Then car11.PlaceOnGround()
