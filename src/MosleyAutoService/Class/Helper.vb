...
Public Module Helper
    ...
    Public bPos1 As New Vector3(-44.32722, -1667.96741, 29.48),
        bPos2 As New Vector3(-44.21046, -1666.50562, 29.4477348),
        bPos3 As New Vector3(-43.06911, -1665.19141, 29.4280983),
        bPos4 As New Vector3(-42.32024, -1664.13831, 29.4624214),
        cPos1 As New Vector3(-37.84413, -1660.94958, 29.46),
        cPos2 As New Vector3(-35.61622, -1658.23523, 29.46),
        cPos3 As New Vector3(-33.4662857, -1655.48657, 29.46),
        cPos4 As New Vector3(-31.58375, -1652.84619, 29.42),
        cPos5 As New Vector3(-24.82662, -1645.02344, 29.46),
        cPos6 As New Vector3(-22.80617, -1642.54871, 29.46),
        cPos7 As New Vector3(-19.8982735, -1642.803, 29.46),
        cPos8 As New Vector3(-19.3836117, -1656.12292, 29.46),
        cPos9 As New Vector3(-10.7235308, -1676.69067, 29.46),
        cPos10 As New Vector3(-16.9800358, -1653.8728, 29.46),
        cPos11 As New Vector3(-26.6400089, -1658.14563, 29.86)
    ...
    Public srDoor As Vector3 = New Vector3(-37.67852, -1671.333, 28.48229), PlayerLastPos As Vector3
    ...
    Public Sub SpawnPed(pedhash As PedHash, ByRef ped As Ped, pos As Vector3, head As Single, frozen As Boolean)
        If ped = Nothing Then
            ped = World.CreatePed(pedhash, pos, head)
            ped.IsPersistent = True
            ped.Task.LookAt(Game.Player.Character)
            ped.AlwaysKeepTask = True
            ped.FreezePosition = frozen
        End If
    End Sub
    ...
    Public Sub SpawnVehicle(model As String, ByRef veh As Vehicle, pos As Vector3, ByRef rot As Vector3, frozen As Boolean)
        Try
            If veh = Nothing Then
                Dim newPos As New Vector3(pos.X, pos.Y, pos.Z - 1.0F)
                veh = World.CreateVehicle(model, newPos, rot.Z)
                veh.FreezePosition = frozen
